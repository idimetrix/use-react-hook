...
>
> ```sh
> git remote add upstream https://github.com/idimetrix/use-react-hook.git
> git fetch upstream
...
Please have a look at the [open issues](https://github.com/idimetrix/use-react-hook/issues) and respond to questions, bug reports and feature requests. Thanks!
